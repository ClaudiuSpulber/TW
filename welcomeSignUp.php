        ...
        <div class="box2">
            <div class="little-container">
                ...
                <form method="post" action="welcomeSignUp.php">
                    ...
                    <input type="text" id="email" name="email" value="<?php echo $email; ?>" class="form2" maxlength="255" placeholder="E-mail"
                        required="required"><br>
                    ...
                    <input type="text" id="username" name="username" value="<?php echo $username; ?>" class="form2" maxlength="255" placeholder="Username"
                        required="required"><br>
                    <input type="text" id="password" name="password" class="form2" maxlength="255" placeholder="Password"
                        required="required">
